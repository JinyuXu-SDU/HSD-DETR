...
from ultralytics.utils.metrics import bbox_iou,RF_MPDIoU
...
class DETRLoss(nn.Module):
    ...
    def _get_loss_bbox(
        ...
        iou = RF_MPDIoU(pred_bboxes, gt_bboxes, xywh=True, mpdiou_hw=1.0)
        loss[name_giou] = 1.0 - iou
    ...
    def _get_loss(
        ...
        if len(gt_bboxes):
            ...
            gt_scores[idx] = RF_MPDIoU(pred_bboxes.detach(), gt_bboxes, xywh=True, mpdiou_hw=1.0).squeeze(-1)
    ...
    def forward(
        ...
        Args:
            ...
            batch (dict): Batch information containing cls, bboxes, and gt_groups.
            postfix (str, optional): Postfix for loss names.
            **kwargs: Additional arguments, may include 'match_indices'.
